    ...
    <div className="space-y-8">
      <div className="bg-gray-900 p-6 rounded-lg border border-gray-800">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-semibold text-white">Overall Rating</h2>
      ...
      <div className="bg-gray-900 p-6 rounded-lg border border-gray-800">
        <h2 className="text-2xl font-semibold mb-4 text-white">AI Summary</h2>
        <AIReviewSummary reviews={reviews} />
      </div>

      <div>
        <h2 className="text-2xl font-semibold mb-6 text-white">User Reviews</h2>
